function UET(o) {
    ...
    this.loadConfig = function() {
        ...
        for (f in o) c.hasOwnProperty(f) && (this.beaconParams[f] = c[f] === 1 ? encodeURIComponent(o[f]) : o[f]);
        for (this.beaconParams.mid = this.getUuidV4(!0), t = undefined, l = 0; l < 5; l++)
            if (t = "ueto_" + this.makeRandomStr(10), !window[t]) break;
        this.stringExists(o.ti) && (p = ["56004448", "5798164", "20132024", "4000835", "4074038"], a = window.navigator.userLanguage || window.navigator.language, this.stringExists(a) && a.indexOf("de") === 0 && p.indexOf(o.ti) !== -1 && (this.uetConfig.deBlock = !0, this.uetConfig.cookieAllowed = !1));
        try {
            this.stringExists(t) && !window[t] ? window[t] = this.uetInstance : t = undefined
        } catch (n) {}
        this.stringExists(o.ti) && (n = document.createElement("script"), v = e + "//" + this.domain + "/p/action/" + o.ti + ".js", this.stringExists(this.uetConfig.batDebug) && (v += "?bat_debug=" + this.uetConfig.batDebug), n.src = v, n.type = "text/javascript", n.async = 1, t && n.setAttribute("data-ueto", t), document.head.appendChild(n));
        navigator.userAgentData && navigator.userAgentData.getHighEntropyValues && navigator.userAgentData.platform === "Windows" && (this.deferLoad = !0, r = this, y = setTimeout(function() {
            r.deferLoad = !1;
